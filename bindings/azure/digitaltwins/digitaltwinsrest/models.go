...
const fqdn = "digitaltwinsrest"
        ...
        // MarshalJSON is the custom marshaler for DigitalTwinsModelData.
        func (dtmd DigitalTwinsModelData)MarshalJSON() ([]byte, error){
        objectMap := make(map[string]interface{})
                if(dtmd.DisplayName != nil) {
                objectMap["displayName"] = dtmd.DisplayName
                }
                if(dtmd.Description != nil) {
                objectMap["description"] = dtmd.Description
                }
                if(dtmd.ID != nil) {
                objectMap["id"] = dtmd.ID
                }
                if(dtmd.UploadTime != nil) {
                objectMap["uploadTime"] = dtmd.UploadTime
                }
                if(dtmd.Decommissioned != nil) {
                objectMap["decommissioned"] = dtmd.Decommissioned
                }
                if(dtmd.Model != nil) {
                objectMap["model"] = dtmd.Model
                }
        ...
        irc: cur,
            ...
            // ListDigitalTwinsModelData ...
            type ListDigitalTwinsModelData struct {
            autorest.Response `json:"-"`
            Value *[]DigitalTwinsModelData `json:"value,omitempty"`
            }
            ...
            // PagedDigitalTwinsModelDataCollectionIterator provides access to a complete listing of
            // DigitalTwinsModelData values.
        ...
        // Value returns the current value or a zero-initialized value if the
        // iterator has advanced beyond the end of the collection.
        func (iter PagedDigitalTwinsModelDataCollectionIterator) Value() DigitalTwinsModelData {
        if !iter.page.NotDone() {
        ...
        return PagedDigitalTwinsModelDataCollectionIterator{page: page}
            ...
            // PagedDigitalTwinsModelDataCollectionPage contains a page of DigitalTwinsModelData values.
        ...
        // Values returns the slice of values for the current page or nil if there are no values.
        func (page PagedDigitalTwinsModelDataCollectionPage) Values() []DigitalTwinsModelData {
